...
// restarting Astro. The TTL exists for the on-demand routes (per-locale
// sitemaps, /latest): without it a long-running server serves stale
// responses until eviction or restart.
